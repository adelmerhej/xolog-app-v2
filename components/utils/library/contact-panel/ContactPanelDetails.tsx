...
import { CardActivities } from '@/components/utils/library/card-activities/CardActivities';
...
const renderCustomTitle = (item: { title: string }) => {
  return (
    <>
...
export const ContactPanelDetails = ({ contact, isOpened, changePanelOpened, onDataChanged, changePanelPinned } : { contact: Contact, isOpened: boolean, changePanelOpened:(value: boolean)=> void, onDataChanged:(data: Contact)=> void, changePanelPinned:() => void }) => {
