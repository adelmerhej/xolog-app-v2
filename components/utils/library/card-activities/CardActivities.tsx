...
import { CardMenu } from '@/components/utils/library/card-menu/CardMenu';

import { formatDate } from 'devextreme/localization';

import classNames from 'classnames';

import { Activities, Activity } from '@/components/types/card-activities';
...
const ActivitiesList: React.FC<{ activities?: Activities }> = ({ activities }) => {
  return (
