...
import { getSizeQualifier } from '@/components/utils/media-query';

export const ContactNewForm = ({ initData, onDataChanged }: { initData: Contact, onDataChanged: (data: Contact) => void }) => {
